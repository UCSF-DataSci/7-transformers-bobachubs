...
def test_chat(questions, model_name="", api_key=None):
    ...
    for question in questions:
        ...
        response = get_contextual_response(question, [], model_name, api_key, history_length=3)
...
if __name__ == "__main__":
    ...
    results = test_chat(test_questions, model_name="HuggingFaceH4/zephyr-7b-beta", api_key=api_key)
